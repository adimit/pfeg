...
%% I'm discontent with the pattern matching description here. Elaborate in
%% sec:search-patterns? Then leave out here?
...
\pair{\ldots,w_{-2},w_{-1},w_0,w_1,w_2,\ldots}, a \emph{context pattern}, the
...
corpus, especially short ones. % FIXME: Maybe make a zipf-style statistic about
% sentences in DEWAC
...
% FIXME: do we need to eliminate noise at all? Why not just run it like that?
